...
public class Deals extends Baseclass {
	...
	public void columnselector() throws InterruptedException {
		...
		columnselectorsearchbar.sendKeys("tag");
		...
		// Result of the testcase
		if (!hasMatchingOption) {
			System.out.println("No matching option found for '" + "tag" + "'");
		} else if (!testPassed) {
			System.out.println("TestCase Failed: Incorrect filtering behavior");
		} else {
			System.out.println("Test Passed: Correct filtering behavior");
		...
		for (WebElement field : fields) {
			...
			if (label.equalsIgnoreCase("Tag")) {
				if (!checkbox.isSelected() && checkbox.isEnabled()) {
					checkbox.click();
					System.out.println("Selected column: " + "tag");
				} else {
					System.out.println("Column already selected: " + "tag");
				}
				break;
			}
		}
		...
		if (driver.findElement(By.xpath("(//div[@class='f-center-h100 c-pointer'])[16]")).getText()
	...
	public void adddeal() throws InterruptedException {
		...
		System.out.println("🧪" + "Add Deal Testcases");

		Actions actions = new Actions(driver);

		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));

		WebElement adddealbutton = driver.findElement(By.xpath("//button[@class='blue-btn btn btn-secondary']"));

		if (adddealbutton.isDisplayed() && adddealbutton.isEnabled() && (adddealbutton.getText()).equals("Add Deals")) {
			System.out.println("Add Deal Button is working.- Testcase Passed");
		} else {
			System.out.println("Add Deal Button is not Working. - Testcase Failed");
		}

		wait.until(ExpectedConditions.elementToBeClickable(adddealbutton));
		adddealbutton.click();
		if (driver.findElement(By.xpath("//div[@class='customcss-drawer-header']")).isDisplayed()) {
			System.out.println("Add Deal Drawer Opened.- Testcase Passed");
		} else {
		...
		name.sendKeys(valuepro.getProperty("Name"));

		if (name.getDomProperty("value").equals(valuepro.getProperty("Name"))) {
		...
		WebElement Ownerdropdown = driver.findElement(By.xpath("(//div[@class=' css-19bb58m'])[1]//input"));
		Ownerdropdown.click();
		...
		Ownerdropdown.sendKeys(valuepro.getProperty("Owner_Deal"));// Enter the Preferred Value
		actions.sendKeys(Keys.ENTER).perform();// Wait and press ENTER to select the typed value

		if (Ownerdropdown.getDomAttribute("value").equalsIgnoreCase(valuepro.getProperty("Owner_Deal"))) {
			System.out.println("Owner Dropdown Value Selected Correctly - TestCase Passed");
		} else if (Ownerdropdown.getDomAttribute("value")==null) {
			System.out.println("Nul da");
		} {
		...
		WebElement countrycodetextbox = driver.findElement(By.xpath("(//div[@class=' css-19bb58m'])[2]//input"));
		...
		countrycodetextbox.sendKeys(valuepro.getProperty("Country_Code_Deal"));// Enter the Preferred Value
		actions.sendKeys(Keys.ENTER).perform();// Wait and press ENTER to select the typed value

		if ((driver.findElement(By.xpath("(//div[@class=' css-hlgwow'])[2]")).getText())
				.equals(valuepro.getProperty("Country_Code_Deal"))) {
		...
		phonenumbertextbox.sendKeys(valuepro.getProperty("Phone_Number_Deal"));
		if (phonenumbertextbox.getDomProperty("value").equals(valuepro.getProperty("Phone_Number_Deal"))) {
		...
		emailtextbox.sendKeys(valuepro.getProperty("Email-Id"));
		if (emailtextbox.getDomProperty("value").equals(valuepro.getProperty("Email-Id"))) {
		...
		WebElement pipelinedropdown = driver.findElement(By.xpath("(//div[@class=' css-19bb58m'])[3]//input"));
		...
		pipelinedropdown.sendKeys(valuepro.getProperty("Pipeline_Deal"));// Enter the Preferred Value

		actions.sendKeys(Keys.ENTER).perform();// Wait and press ENTER to select the typed value

		if ((driver.findElement(By.xpath("(//div[@class=' css-hlgwow'])[3]")).getText())
				.equalsIgnoreCase(valuepro.getProperty("Pipeline_Deal"))) {
		...
		WebElement pipelinestagedropdown = driver.findElement(By.xpath("(//div[@class=' css-19bb58m'])[4]//input"));
		...
		pipelinestagedropdown.sendKeys(valuepro.getProperty("Pipeline_Stage_Deal"));// Enter the Preferred Value
		actions.sendKeys(Keys.ENTER).perform();// Wait and press ENTER to select the typed value

		if ((driver.findElement(By.xpath("(//div[@class=' css-hlgwow'])[4]")).getText())
				.equalsIgnoreCase(valuepro.getProperty("Pipeline_Stage_Deal"))) {
		...
		wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class=' css-19bb58m']//input)[7]")));
		WebElement productdropdown = driver.findElement(By.xpath("(//div[@class=' css-19bb58m']//input)[7]"));
		productdropdown.click();
		String Expanded6 = productdropdown.getDomAttribute("aria-expanded");
		if (productdropdown.isDisplayed() && productdropdown.isEnabled()) {
			System.out.println("Product dropdown is Visible and Editable.- Testcase Passed");
		} else {
			System.out.println("Product dropdown is not Visible and Editable.- Testcase Failed");
		}
		if (Expanded6 != null && Expanded6.equals("true")) {
			System.out.println("The Product dropdown is expanded - TestCase Passed");
		} else {
			System.out.println("The Product dropdown is collapsed - TestCase Failed" + productdropdown);
		}
		productdropdown.sendKeys(valuepro.getProperty("Product_Deal"));// Enter the Preferred Value
		actions.sendKeys(Keys.ENTER).perform();// Wait and press ENTER to select the typed value

		if ((driver.findElement(By.xpath("//div[@class=' css-5ptr61']")).getText())
				.equalsIgnoreCase(valuepro.getProperty("Product_Deal"))) {
			System.out.println("Product Dropdown Value Selected Correctly - TestCase Passed");
		} else {
			System.out.println("Product Dropdown Value Not Selected Correctly - TestCase Failed"
					+ productdropdown.getDomAttribute("value"));
		}

		// Select Source dropdown
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class=' css-19bb58m']//input)[11]")));
		WebElement sourcedropdown = driver.findElement(By.xpath("(//div[@class=' css-19bb58m']//input)[11]"));
		...
		sourcedropdown.sendKeys(valuepro.getProperty("Source_Deal"));// Enter the Preferred Value
		actions.sendKeys(Keys.ENTER).perform();// Wait and press ENTER to select the typed value

		if ((driver.findElement(By.xpath("(//div[@class=' css-19bb58m'])[7]")).getText())
				.equalsIgnoreCase(valuepro.getProperty("Source_Deal"))) {
		...
		if (addedlead.getText().contains(valuepro.getProperty("Name"))) {
		...
		System.out.println("✅" + "Add Deals Testcases Executed");
		System.out.println();
	}
...
/////////////// Add Tags Button  ///////////////////////////////////
		...
		WebElement addtaginputdropdown = driver.findElement(By.xpath("//div[@class=' css-19bb58m']//input"));// Check
																												...
																												// of
																												// Tag
		addtaginputdropdown.sendKeys("Repeat");// Enter the Value in dropdown
		Thread.sleep(2000);
...
//////////////////// BulkEmail Button  //////////////////////////////////
		...
		WebElement sendbutton = waittime.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[text()='Send']")));
		...
		tomail.sendKeys(valuepro.getProperty("Email-Id-Deal"));
		...
		ccmail.sendKeys(valuepro.getProperty("ccmail-Id-Deal"));
		ccmail.sendKeys(Keys.ENTER);
		
		// Select the template
		Thread.sleep(4000);
		// Click the dropdown and select the first option
		...
		if (selectedtemplateText.equalsIgnoreCase("Select Template") || selectedtemplateText.isEmpty()) {
		    ...
		    content.sendKeys(valuepro.getProperty("Content-Deal"));
		} else {
		...
		if(!selectedtemplateText.isEmpty()) {
			...
			subject.sendKeys(valuepro.getProperty("Subject-Deal"));
			Thread.sleep(1000);
			if(subject.getDomProperty("value").equalsIgnoreCase(valuepro.getProperty("Subject-Deal"))) {
...
///////////////////////// Assign Button///////////////////////////////
		...
		WebElement optionselect = wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//div[contains(@class,'-option') and text()='" + valuepro.getProperty("Owner_Name_Deal") + "']")));// Select
																														// specific
																														// value
		...
		WebElement ownerdata = driver.findElement(By.xpath("(//div[@class='f-center-h100'])[2]"));// Find the element of
																									// ownerof that lead
		if (ownerdata.getText().equalsIgnoreCase(valuepro.getProperty("Owner_Name_Deal"))) {
