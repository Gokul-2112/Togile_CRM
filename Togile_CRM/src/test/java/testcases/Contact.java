...
public class Contact extends Baseclass {
	...
	public void columnselector() throws InterruptedException {
		...
		if (driver.findElement(By.xpath("(//div[@class='f-center-h100 c-pointer'])[9]")).getText()
	...
	public void addcontact() throws InterruptedException {
		...
		WebElement addcontactbutton = driver.findElement(By.xpath("//button[@class='blue-btn btn btn-secondary']"));

		if (addcontactbutton.isDisplayed() && addcontactbutton.isEnabled()
				&& (addcontactbutton.getText()).equals("Add Contacts")) {
			System.out.println("Add Contacts Button is working.- Testcase Passed");
		} else {
			System.out.println("Add Contacts Button is not Working. - Testcase Failed");
		}
		...
		if (driver.findElement(By.xpath("//div[@class='customcss-drawer-header']")).isDisplayed()) {
			System.out.println("Add Contacts Drawer Opened.- Testcase Passed");
		} else {
			System.out.println("Add Contacts Drawer not Opened.- Testcase Failed");
		}
		// Salutation
		WebElement salutation = wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class=' css-19bb58m'])[1]//input")));
		salutation.click();
		String Expanded2 = salutation.getDomAttribute("aria-expanded");// Dropdown Expand Check
		if (salutation.isDisplayed() && salutation.isEnabled()) {
			System.out.println("Salutation dropdown is Visible and Editable.- Testcase Passed");
		} else {
			System.out.println("Salutation dropdown is not Visible and Editable.- Testcase Failed");
		}
		if (Expanded2 != null && Expanded2.equals("true")) {
			System.out.println("The Salutation dropdown is expanded - TestCase Passed");
		} else {
			System.out.println("The Salutation dropdown is collapsed - TestCase Failed" + Expanded2);
		}
		salutation.sendKeys(valuepro.getProperty("Salutation"));// Enter the Preferred Value

		actions.sendKeys(Keys.ENTER).perform();// Wait and press ENTER to select the typed value

		if ((driver.findElement(By.xpath("(//div[contains(@class,'singleValue')])[1]")).getText())
				.equalsIgnoreCase(valuepro.getProperty("Salutation"))) {
			System.out.println("Salutation Dropdown Value Selected Correctly - TestCase Passed");
		} else {
			System.out.println("Salutation Dropdown Value Not Selected Correctly - TestCase Failed"
					+ (driver.findElement(By.xpath("(//div[contains(@class,'singleValue')])[1]")).getText()));
		}
		...
		firstname.sendKeys(valuepro.getProperty("Firstname_Contact"));

		if (firstname.getDomProperty("value").equals(valuepro.getProperty("Firstname_Contact"))) {
		...
		// Email
		WebElement emailtextbox = driver.findElement(By.xpath("(//input[@class='form-control' and @type='text'])[2]"));
		...
		emailtextbox.sendKeys(valuepro.getProperty("Email_Id_Contact"));
		if (emailtextbox.getDomProperty("value").equals(valuepro.getProperty("Email_Id_Contact"))) {
		...
		countrycodetextbox.sendKeys(valuepro.getProperty("Country_Code_Contact"));// Enter the Preferred Value
		actions.sendKeys(Keys.ENTER).perform();// Wait and press ENTER to select the typed value

		if ((driver.findElement(By.xpath("(//div[contains(@class,'singleValue')])[2]")).getText())
				.equals(valuepro.getProperty("Country_Code_Contact"))) {
		...
		WebElement phonenumbertextbox = driver
				.findElement(By.xpath("(//input[@class='form-control' and @type='text'])[3]"));
		...
		phonenumbertextbox.sendKeys(valuepro.getProperty("Phone_Number_Contact"));
		if (phonenumbertextbox.getDomProperty("value").equals(valuepro.getProperty("Phone_Number_Contact"))) {
		...
		WebElement Ownerdropdown = driver.findElement(By.xpath("(//div[@class=' css-19bb58m'])[3]//input"));
		Ownerdropdown.click();
		...
		Ownerdropdown.sendKeys(valuepro.getProperty("Owner_Contact"));// Enter the Preferred Value
		actions.sendKeys(Keys.ENTER).perform();// Wait and press ENTER to select the typed value

		if ((driver.findElement(By.xpath("(//div[contains(@class,'singleValue')])[3]")).getText())
				.equalsIgnoreCase(valuepro.getProperty("Owner_Contact"))) {
			...
			System.out.println("Owner Dropdown Value Not Selected Correctly - TestCase Failed"
					+ (driver.findElement(By.xpath("(//div[contains(@class,'singleValue')])[3]")).getText()));
		}

		// Select Source dropdown
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class=' css-19bb58m']//input)[4]")));
		WebElement sourcedropdown = driver.findElement(By.xpath("(//div[@class=' css-19bb58m']//input)[4]"));
		...
		sourcedropdown.sendKeys(valuepro.getProperty("Source_Contact"));// Enter the Preferred Value
		actions.sendKeys(Keys.ENTER).perform();// Wait and press ENTER to select the typed value

		if ((driver.findElement(By.xpath("(//div[contains(@class,'singleValue')])[4]")).getText())
				.equalsIgnoreCase(valuepro.getProperty("Source_Contact"))) {
			...
			System.out.println("Source Dropdown Value Not Selected Correctly - TestCase Failed"
					+ driver.findElement(By.xpath("(//div[contains(@class,'singleValue')])[4]")).getText());
		}
		...
		WebElement addedcontact = driver.findElement(By.xpath("(//div[@class='f-center-h100 '])[1]"));
		if (addedcontact.getText().contains(valuepro.getProperty("Firstname_Contact"))) {
			System.out.println("Contact Created Successfully. - Testcase Passed");
		} else {
			System.out.println("Contact Not Created. - Testcase Failed" + addedcontact.getText());
		}
		System.out.println("✅" + "Add Contact Testcases Executed");
		System.out.println();
	}
...
/////////////// Add Tags Button  ///////////////////////////////////
		...
		WebElement addtaginputdropdown = driver.findElement(By.xpath("//div[@class=' css-19bb58m']//input"));// Check
																												...
																												// of
																												// Tag
		addtaginputdropdown.sendKeys("Fresh Contact");// Enter the Value in dropdown
		Thread.sleep(2000);
...
///////////////////////// Assign Button///////////////////////////////
		...
		WebElement ownerdata = driver.findElement(By.xpath("(//div[@class='f-center-h100'])[3]"));// Find the element of
																									// ownerof that lead
		if (ownerdata.getText().equalsIgnoreCase(valuepro.getProperty("Owner_Name_Contact"))) {
